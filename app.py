    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("Analysis Part 2",  href="/analysis-2", id="page-3-link"),
                dbc.NavLink("Dates",  href="/analysis-3", id="page-4-link"),
                dbc.NavLink("Common Words",  href="/analysis-4", id="page-5-link")
            ],
            vertical=True,
            pills=True,
        ),
...
def toggle_active_links(pathname):
    ...
    elif pathname == "/analysis-3":
        return False, False, False, True, False
    elif pathname == "/analysis-4":
